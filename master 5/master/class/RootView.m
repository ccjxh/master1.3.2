 ...
 @implementation RootView
{
    ...
    SDRefreshHeaderView *_weakRefreshHeader;//下拉刷新透视图
...
- (void)setupHeaderWithTableview:(UITableView*)tableview
{
    ...
    refreshHeader.normalStateOperationBlock = ^(SDRefreshView *refreshView, CGFloat progress){
        ...
        _animationView.transform = CGAffineTransformConcat(CGAffineTransformMakeTranslation(progress * 10, -20 * progress), CGAffineTransformMakeScale(progress, progress));
        _boxView.transform = CGAffineTransformMakeTranslation(- progress * 90, progress * 35);
    };
    ...
    refreshHeader.refreshingStateOperationBlock = ^(SDRefreshView *refreshView, CGFloat progress){
        ...
        [UIView animateWithDuration:1.5 animations:^{
            _animationView.transform = CGAffineTransformMakeTranslation(200, -20);
        }];
    };
