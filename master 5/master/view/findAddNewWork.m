...
{
    NSInteger _currentCount;//当前显示几行
...
-(void)initData{
    ...
    _firstArrayPlacea=[[NSMutableArray alloc]initWithObjects:@"请选择招工方式",@"一句话描述您的需求",@"请填写需要的人数",@"请选择待遇的范围",@"请选择工作的地点",@"请填写详细的地址",@"请输入职位的要求",nil];
...
//    if ([_firstArrayPlacea[0] isEqualToString:@"电话联系"]==YES) {
//        _currentCount=2;
//        
//    }else{
//    
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    NSArray*firstArray=@[@"招工方式",@"标       题",@"人       数",@"待       遇",@"工作地点",@"详细地址",@"职位要求"];
