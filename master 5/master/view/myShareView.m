...
-(void)createUI{
    ...
    NSArray*array=@[@"qq",@"QQ空间",@"微信分享",@"朋友圈"];
    ...
    visitLabel.text=[NSString stringWithFormat:@"邀请码:%@",model.inviteCode];
    ...
    switch (button.tag) {
            ...
            //qq好友
        {
            type=SSDKPlatformSubTypeQQFriend;
             NSString*content=[NSString stringWithFormat:@"注册填邀请码获取积分,邀请码是:%@",model.inviteCode];
