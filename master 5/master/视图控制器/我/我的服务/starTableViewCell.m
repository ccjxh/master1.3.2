...
-(void)reloadData{
    ...
    [self.iageview sd_setImageWithURL:[NSURL URLWithString:urlString] placeholderImage:[UIImage imageNamed:headImageName]];
    self.date.text=self.model.createTime;
    [self.iageview setContentScaleFactor:[[UIScreen mainScreen] scale]];
    self.iageview.contentMode =  UIViewContentModeScaleAspectFill;
    self.iageview.autoresizingMask = UIViewAutoresizingFlexibleWidth;
    self.iageview.clipsToBounds=YES;
