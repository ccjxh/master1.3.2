...
-(void)reloadPic{
    ...
    [self.photos setContentScaleFactor:[[UIScreen mainScreen] scale]];
    self.photos.contentMode =  UIViewContentModeScaleAspectFill;
    self.photos.autoresizingMask = UIViewAutoresizingFlexibleWidth;
