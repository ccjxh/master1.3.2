...
- (void)viewDidLoad {
    ...
    self.commonAdressTbView.tableFooterView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 20)];
    _currentPage=1;
    self.isRefersh=YES;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self pushWinthAnimation:self.navigationController Viewcontroller:ctl];
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"useNormal" object:nil userInfo:dict];
