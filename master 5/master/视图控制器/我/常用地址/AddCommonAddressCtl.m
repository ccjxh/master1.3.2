...
-(void)setModel:(normalAdress *)model{

    _model=model;
    [_subDict setObject:[NSString stringWithFormat:@"%ld",model.id] forKey:@"regionId"];
    [_subDict setObject:model.street forKey:@"street"];
...
-(void) addressTap
{
    ...
    ProvinceTableViewController *pVC = [[ProvinceTableViewController alloc]initWithType:1];
