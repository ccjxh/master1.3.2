...
-(NSString*)interfaceFromString:(interface)string
{
    ...
    switch (string) {
        ...
        case interface_deleBill:
            ...
            break;
            case interface_existMobile:
            urlString=@"user/validateMobile";
            break;
            case interface_resogn:
            urlString=@"user/register";
            break;
            case interface_updatePrjectCase:
            urlString=@"servicer/updatePrjectCase";
            break;
            case interface_updateBuyer:
            urlString=@"servicer/updateBuyer";
            break;
            case interface_updateTeamScale:
            urlString=@"servicer/updateTeamScale";
            break;
            case interface_uploadPhotos:
            urlString=@"masterProjectCase/save";
            break;
            case interface_qqLogin:
            urlString=@"user/loginBy3rd";
            break;
            case interface_Connect:
            urlString=@"user/login";
            break;
            case interface_updateCase:
        urlString=@"masterProjectCase/updateAll";
            break;
            case interface_checkServicePhone:
            urlString=@"user/conCustService";
            break;
            case interface_allAddress:
            urlString=@"location/queryCountryByOpen";
            break;
            case interface_refuseFinfWoker:
            urlString=@"project/applyFull";
            break;
            case interface_apply:
            urlString=@"project/apply";
            break;
            case interface_getapplyPerson:
            urlString=@"project/getApplyPerson";
            break;
            case interface_helpAddWork:
            urlString=@"admin/help/queryProjectDemo";
            break;
             default:
            break;
                }
