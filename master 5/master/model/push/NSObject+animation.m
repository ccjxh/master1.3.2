...
-(CGFloat)accountStringHeightFromString:(NSString *)str Width:(CGFloat)width FrontSize:(NSInteger)size{
    CGFloat height;
    height = [str  boundingRectWithSize:CGSizeMake(width, 10000) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObject:[UIFont systemFontOfSize:size] forKey:NSFontAttributeName] context:nil].size.height;
    return height;
