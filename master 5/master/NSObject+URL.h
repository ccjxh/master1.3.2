...
typedef  enum
{
    ...
    interface_existMobile,//检测手机号是否已经注册过
    interface_updatePrjectCase,//**更新过往工地*/
    interface_updateBuyer,//**更新合作过的雇主*/
    interface_updateTeamScale,//**更新团队规模*/
    interface_uploadPhotos,//上传照片
    interface_qqLogin,//qq登陆
    interface_Connect,//绑定账号
    interface_updateCase,//更新工程案例
    interface_checkServicePhone,//检查客服电话
    interface_allAddress,//所有地址
    interface_refuseFinfWoker,//招满
    interface_apply,//报名参加
    interface_getapplyPerson,//参加报名人的列表
    interface_helpAddWork,//查看招工样例
